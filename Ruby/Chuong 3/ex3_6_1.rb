...
if so_kw <= 50
  ...
  tien_dien = BAC50 * MUC1 + BAC50 * MUC2 + BAC100 * MUC3 + (so_kw - BAC200) * MUC4
elsif so_Kw <=400
  tien_dien = BAC50 * MUC1 + BAC50 * MUC2 + BAC100 * MUC3 + BAC100 * MUC4 + (so_kw - BAC300) * MUC5
else so_kw >=401
  tien_dien = BAC * MUC1 + BAC50 * MUC2 + BAC100 * MUC3 + BAC100 * MUC4 + BAC100 * MUC5 + (so_kw - BAC400) * MUC6
end
